...
export function ClipboardFooter() {
  return (
    <div className="flex-1 flex flex-col justify-end lg:px-8 px-6 lg:pb-8 pb-6">
      ...
      <div className="relative w-full flex xl:flex-row flex-col items-center justify-center xl:gap-4 gap-1 mx-auto mt-8 px-8 bg-orange-500 mix-blend-darken">
        <p className="font-bold xl:text-base text-sm text-balance xl:text-left text-center">
